...
namespace rossum.Tools.OrderedDictionary
{
    /// <summary>
    ...
    public class OrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue> 
    {
        ...
        public void SetItem(int index, TValue value)
        {
            if (index < 0 || index >= _keyedCollection.Count)
            {
                throw new ArgumentException("The index is outside the bounds of the dictionary");
            }
        ...
        public TValue GetValue(TKey key)
        {
            ...
            {
                throw new ArgumentException("The given key is not present in the dictionary");
            }
